...
const RelationshipTimer = ({ startDate }: { startDate: string }) => {
  ...
  return (
    <div className="flex flex-col items-center space-y-1">
      <div className="font-mono text-2xl flex gap-3 text-purple-300">
      ...
      <div className="flex gap-4 text-sm text-purple-400/80">
        <span>{t('common.years')}</span>
        <span>{t('common.months')}</span>
        <span>{t('common.days')}</span>
      </div>
      <div className="font-mono text-lg flex gap-2 mt-2 text-pink-300">
